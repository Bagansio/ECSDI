    ...
    if msgdic is None:
        ...
        if perf != ACL.request:
            ...
            if 'content' in msgdic:
                ...
                if accion == ECSDI.AñadirProductoExterno:
