...
DBProductos = '../data/DBProductos.owl'
DBCompras = '../data/DBCompras.owl'
DBUsuarios = '../data/DBUsuarios.owl'
DBBusquedas = '../data/DBBusquedas.owl'
DBProductosAdquiridos = '../data/DBProductosAdquiridos.owl'
...
DBDevoluciones = '../data/DBDevoluciones.owl'
